...
import com.example.android.marsrealestate.overview.MarApiStatus
...
fun ImageView.bindImage(imgUrl: String?) {
  imgUrl?.let {
      ...
      //TODO: fix stretched out images
      Glide.with(this.context).load(imgUri).into(this).apply {
...
fun ImageView.bindStatus(status: MarApiStatus){
    when(status){
